...
# %% ../nbs/05_utils.ipynb #cc68061e-7bb7-476c-b764-8511ad464745
import os
import openai
...
# %% ../nbs/05_utils.ipynb #4903c81d-b409-4469-a418-6a56ca2e34d2
def fw(): return openai.OpenAI(base_url="https://api.fireworks.ai/inference/v1", api_key=os.environ['FIREWORKS_API_KEY'])

# %% ../nbs/05_utils.ipynb #74ff264e-821c-4766-9cf6-6bde59c23ea1
class Reranker:
